...
export const MOCK_REQUISITIONS: Requisition[] = [
  {
    ...
    clicks: 142, completed: 12, live: true, status: 'open',
  },
  {
    ...
    clicks: 89, completed: 4, live: true, status: 'open',
  },
  {
    ...
    clicks: 210, completed: 0, live: false, status: 'paused',
  },
  {
    ...
    clicks: 67, completed: 8, live: true, status: 'open',
  },
  {
    ...
    clicks: 195, completed: 15, live: true, status: 'open',
  },
  {
    ...
    clicks: 312, completed: 0, live: false, status: 'paused',
  },
  {
    ...
    clicks: 34, completed: 2, live: true, status: 'open',
  },
  {
    ...
    clicks: 51, completed: 3, live: true, status: 'open',
  },
];
